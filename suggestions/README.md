# Community Suggestions — responses & status

Suggestions raised in the server's `#suggestions` channel, each with a verdict
and how (or whether) the **Sprite Trade Stop bot** addresses it. "Bot" = this
project; "Server task" = an admin/config decision, not bot code.

| # | Suggestion | Verdict | Bot does it? |
|---|---|---|---|
